...
public class ZKConnect implements Watcher {
	...
	public static final String zkServerPathCluster = "172.16.0.3:2181,172.16.0.3:2182,172.16.0.3:2183";
	...
	public static void main(String[] args) throws Exception {
		 ...
		 */
		ZooKeeper zk = new ZooKeeper(zkServerPathCluster, timeout, new ZKConnect());
